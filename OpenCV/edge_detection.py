...
current_dir = "C:\\Users\\dby_freedom\\Desktop\\661\\OpenCV_test"
path_test_image = os.path.join(current_dir, '../Image/1.jpg')
...
new_shape = (image_color.shape[1] * 4, image_color.shape[0] * 4)
